    ...
    public partial class intialise : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.PictureModels", t => t.PictureId, cascadeDelete: true)
                .Index(t => t.CusineId)
                ...
                c => new
                    {
                        ...
                        picture = c.Binary(),
                        datePictureAdded = c.DateTime(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.RecipeModels", "PictureId", "dbo.PictureModels");
            ...
            DropIndex("dbo.RecipeModels", new[] { "PictureId" });
